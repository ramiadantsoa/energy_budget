...
\caption{
    ...
    (b) Power law functions of body mass, $z$, are used throughout the model.
...
\caption{
	...
	Other assumptions are free convection, warm-up starting half an hour after sunrise, $\rho = 24,\ a_2 = 10,\ a_1 = ??$. % FIXME: need the value for a_1, and b_2
    For a--d, foraging time is $\tau_f = 1$.
    For e--h, $b_3 = 0.75$.
	% For e--h, $b_1 = b_2 = b_3 = 0.75$.  % E: What are b_1 and b_2 in a--d?  Also 0.75?
