...
\label{fig1}
\end{center}
% E: Thanks for adding this figure.  I had a little trouble telling which lines were which---check the thicknesses in the legend, maybe make the gray line thicker.  Maybe also reduce the range of z to make it more obvious that cost can exceed gain for small size; I'm not sure what the final sentence of the caption means in this regard.
\end{figure}
