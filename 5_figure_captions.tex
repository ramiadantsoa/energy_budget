...
\caption{
    ...
    % E: It's okay for now, but eventually the thin-solid and thin-dashed lines need to be easier to distinguish.
...
\caption{
    ...
    Thick, thin, and dashed lines represent endotherms with laminar convection, ectotherms with laminar convection, and ectotherms with free convection, respectively.  % E: It would be easier to read if this info was written in panel a, either on the lines or in a legend.
