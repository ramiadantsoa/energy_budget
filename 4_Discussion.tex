...
These results can be applied into a Bergmann's is the tendency to see larger animals in colder environment.
...
%The initial assumption is For instance, it can be used test various reasons for seeing or not Bergmann's rule \citep{Blackburn1999}.
