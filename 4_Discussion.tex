...
Looking at the ecology of the species: competition...% Still fuzzy here, can you relate to any concrete empirical example?
...
%There are different sorts of behavior, sit and wait or active search...
%Is conductance selected? Colors are for instance important too
%More data is needed to validate if such trait correlates with the thermal and solar regime the population is exposed to.
%
%and the diel activity of the species difference among say diurnal, crepuscular, and nocturnal species
%
%
...
%
%We of course ignore other roles of the conductance here 
%
