...
The converse is also true that convexity benefits larger individuals (\cref{fig3,fig6}b).
...
Bergmann's rule is the macroecological pattern that animals tend to be larger in colder environments \citep{Bergmann1847,Blackburn1999}. 
...
For instance, data has shown that a community of dung beetles are accurate in timing their activities \citep[e.g.,][]{Halffter1966, Caveney1995}
