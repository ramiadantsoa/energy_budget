...
% E: Upon re-reading, I still think that beginning with geographic range may set the reader's expectations in the wrong place.  In the same style but more general, perhaps the goal is to understand processes that affect performance and hence shape distribution, community composition, etc.
...
Such models help to understand the qualitative and quantitative shape of the performance curves and how they differ  among individuals, but it does not provide a framework for understanding the intrinsic causes of those differences. % E: I like this.  Might just need to clarify that "development curve" etc. is not an "intrisic cause".
...
In some communities like dung beetles, it is crucial to arrive on site before resource quality degrades or get depleted \citep{Hanski1991}. %(Anderson & Coe 1974, Horgan 200,  Heinrich & Bartholomew, 1979 ).
...
% E: This following point is great!!
