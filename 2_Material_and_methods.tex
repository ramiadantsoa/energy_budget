...
When environmental temperature is low, an individual needs to reach sufficient internal temperature to be active for foraging. % E: could add "as mentioned earlier" at the end if you want, but better to start with the point
